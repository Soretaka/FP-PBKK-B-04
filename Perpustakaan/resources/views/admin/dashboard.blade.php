...
@section('container')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-download fa-sm text-white-50"></i>{{__('sidebar.report')}}</a>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $members_count }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <!-- Data peminjaman yang belum kembali -->
        <div class="col-xl-3 col-md-6 mb-4">
